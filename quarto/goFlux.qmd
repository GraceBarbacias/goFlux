...
The good news is, we did the research for you! Find the internal volume of each instrument compatible with the goFlux R package in this Excel spreadsheet: {{< downloadthis file="docs/example_auxfile.xlsx" label="download" dname="example_auxfile" id="auxfile-btn" >}}
:::
