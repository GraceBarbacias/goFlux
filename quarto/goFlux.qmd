...
The good news is, we did the research for you! Find the internal volume of each instrument compatible with the goFlux R package in this Excel spreadsheet: {{< downloadthis docs/example_auxfile.xlsx dname="example_auxfile" label="Download" >}}
:::
