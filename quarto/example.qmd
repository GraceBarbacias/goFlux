...
To help you create an auxiliary file (used for the [manual identification of measurements](manualID.qmd#sec-manID)), you can {{< downloadthis docs/example_auxfile.xlsx dname="example_auxfile" label="Download" icon="download" >}} this example Excel spreadsheet.
