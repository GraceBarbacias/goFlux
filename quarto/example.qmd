...
To help you create an auxiliary file (used for the [manual identification of measurements](manualID.qmd#sec-manID)), you can {{< downloadthis file="docs/example_auxfile.xlsx" label="download" dname=example_auxfile id=auxfile-btn >}} this example Excel spreadsheet.
...
{{< downloadthis file="scripts/simple_workflow.zip" label="Simple workflow" >}}
...
{{< downloadthis file="scripts/divided_workflow.zip" label="Divided workflow" >}}
