...
To help you create an auxiliary file (used for the [manual identification of measurements](manualID.qmd#sec-manID)), you can [Download](docs/example_auxfile.xlsx)  label="Download" icon="download" >}} this example Excel spreadsheet.
