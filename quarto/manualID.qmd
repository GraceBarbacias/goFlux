...
You can {{< downloadthis docs/example_auxfile.xlsx dname="example_auxfile" label="Download" >}} an example Excel spreadsheet that you can use to create your auxiliary file.
