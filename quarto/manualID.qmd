...
You can {{< downloadthis file="docs/example_auxfile.xlsx" label="download" dname=example_auxfile id=auxfile-btn >}} an example Excel spreadsheet that you can use to create your auxiliary file.
